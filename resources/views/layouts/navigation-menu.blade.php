<header class="z-10 py-4 bg-white shadow-md dark:bg-gray-800">
      <div class="container flex items-center justify-between h-full px-6 mx-auto text-purple-600 dark:text-purple-300">
          ...
          <ul class="flex items-center flex-shrink-0 space-x-6">
              <!-- Theme toggler -->
              <li class="flex">
                <button id="theme-toggle" type="button" class="rounded-full focus:outline-none focus:shadow-outline-purple p-2.5">
              ...
              <!-- Notifications menu -->
              <div x-data="{ isNotificationsMenuOpen: false }" @click.outside="isNotificationsMenuOpen = false" @keyup.escape="isNotificationsMenuOpen = false">
                <li class="relative">
                    <button class="relative align-middle rounded-full p-2.5 focus:outline-none focus:shadow-outline-purple" x-on:click="isNotificationsMenuOpen = ! isNotificationsMenuOpen" aria-label="Notifications" aria-haspopup="true">
              ...
              <!-- Profile menu -->
              <div x-data="{ isProfileMenuOpen: false }" @click.outside="isProfileMenuOpen = false" @keyup.escape="isProfileMenuOpen = false">
                <li class="relative">
                    <button class="align-middle rounded-full focus:shadow-outline-purple focus:outline-none" x-on:click="isProfileMenuOpen = ! isProfileMenuOpen" aria-label="Account" aria-haspopup="true">
                        ...
                        <ul x-transition:leave="transition ease-in duration-150" x-transition:leave-start="opacity-100" x-transition:leave-end="opacity-0" class="absolute right-0 w-56 p-2 mt-2 space-y-2 text-gray-600 bg-white border border-gray-100 rounded-md shadow-md dark:border-gray-700 dark:text-gray-300 dark:bg-gray-700" aria-label="submenu">
                            <li class="flex">
                                <a class="inline-flex items-center w-full px-2 py-1 text-sm font-semibold transition-colors duration-150 rounded-md hover:bg-gray-100 hover:text-gray-800 dark:hover:bg-gray-800 dark:hover:text-gray-200" href="/user/profile">
                                    <svg class="w-4 h-4 mr-3" aria-hidden="rue" fill="none" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" viewBox="0 0 24 24" stroke="currentColor">
